...
import {getZach} from "../../http/monitorApi";
...
const ZayavlenyiPoInstitutMain = () => {
    ...
    if (fetchedData) {
      ...
      chartRef.current = new Chart(ctx, {
        ...
        data: {
          labels: dates,
          datasets: [{
            label: 'Заявлений по институтам',
            data: counts,
            borderWidth: 1,
          },
          {
            label: 'Согласий по институтам',
            data: counts1,
            borderWidth: 1,
          },
          ],
...
export default ZayavlenyiPoInstitutMain;
