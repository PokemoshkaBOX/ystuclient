...
import {BUILD_ROUTE} from "../../utils/consts";
        ...
        <Container fluid style={{paddingTop: 10}}>
            <Row>
                <Col md={12} xs={11} style={{textAlign: "center"}}>
                    <h2>Статистика приёмной компании по институту <b style={{color: "rgb(30, 145, 221)"}}>экономики и менеджмента</b> {currentDateTime.toLocaleDateString('ru-RU', options)}</h2>
                </Col>
            </Row>
            <Row>
                <Col md={3}>
